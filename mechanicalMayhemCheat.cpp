...
int main(){
    ...
    // Gear names: blue / orange / small / yellow / silver / purple / spike / grey   

    placeGears(p13, "blue" , "small" , "yellow" , "grey");
    placeGears(p2,"yellow","orange", "blue" , "blue");
    placeGears(p10, "silver" , "grey" , "purple" , "grey");
    placeGears(p9, "blue" , "blue" , "spike" , "yellow");
    placeGears(p1, "purple" , "orange" , "orange" , "spike");
    placeGears(p6, "orange" , "yellow" , "orange" , "blue");
    placeGears(p3, "small" , "blue" , "grey" , "yellow");
    placeGears(p4, "blue" , "small" , "yellow" , "orange");
    placeGears(p5, "small" , "purple" , "blue" , "yellow");
    placeGears(p14, "small" , "yellow" , "blue" , "yellow");
    placeGears(p16, "yellow" , "orange" , "blue" , "yellow");
    placeGears(p12, "small" , "silver" , "spike" , "small");
    placeGears(p11, "orange" , "blue" , "yellow" , "purple");
    placeGears(p15, "yellow" , "orange" , "small" , "blue");
    placeGears(p8, "orange" , "purple" , "blue" , "spike");
    placeGears(p7, "orange" , "blue" , "yellow" , "orange");
